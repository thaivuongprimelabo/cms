									...
									<ul>
										<li>
											<a href="#" class="clearfix">
												<figure class="image">
													<img src={{ url('assets/images/!sample-user.jpg') }} alt="Joseph Doe Junior" class="img-circle" />
												</figure>
										...
										<li>
											<a href="#" class="clearfix">
												<figure class="image">
													<img src={{ url('assets/images/!sample-user.jpg') }} alt="Joseph Junior" class="img-circle" />
												</figure>
										...
										<li>
											<a href="#" class="clearfix">
												<figure class="image">
													<img src={{ url('assets/images/!sample-user.jpg') }} alt="Joe Junior" class="img-circle" />
												</figure>
										...
										<header class="panel-heading bg-primary">
											...
											<div class="widget-profile-info">
												<div class="profile-picture">
													<img src={{ url('assets/images/!logged-user.jpg') }}>
												</div>
												...
												<li>
													<div class="tm-box">
														...
														<div class="thumbnail-gallery">
															<a class="img-thumbnail lightbox" href={{ url('assets/images/projects/project-4.jpg') }} data-plugin-options='{ "type":"image" }'>
																<img class="img-responsive" width="215" src={{ url('assets/images/projects/project-4.jpg') }}>
																<span class="zoom">
							...
							<div class="sidebar-widget widget-friends">
								...
								<ul>
									<li class="status-online">
										<figure class="profile-picture">
											<img src={{ url('assets/images/!sample-user.jpg') }} alt="Joseph Doe" class="img-circle">
										</figure>
										<div class="profile-info">
